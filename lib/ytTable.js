...
var SelectCell = function (_React$Component) {
    ...
    SelectCell.prototype.render = function render() {
        ...
        return React.createElement(
            'select',
            { value: value, className: ytTablePerfix$5 + '-cell-select', onChange: this.onChange },
            React.createElement(
                'option',
                { value: 'ss' },
                'sss'
...
var Select = function (_React$Component) {
	...
	function Select() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {}, _this.handleFocus = function () {
			if (_this._focused) {
				return;
			}
			_this._focused = true;
	...
	Select.prototype.render = function render() {
		...
		return React.createElement(
			'div',
			{
				...
				onFocus: this.handleFocus,
				onBlur: this.handleBlur,
				className: prefix + ' ' + (this._focused ? prefix + '-focused' : '')
			},
			React.createElement(
				'ul',
				{ className: prefix + '-drop-down ' + (this._focused ? '' : prefix + '-display-none') },
