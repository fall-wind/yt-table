(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('rc-select'), require('react'), require('prop-types'), require('classnames')) :
  typeof define === 'function' && define.amd ? define(['rc-select', 'react', 'prop-types', 'classnames'], factory) :
  (global.ytTable = factory(global.rc-select,global.React,global.PropTypes,global.classnames));
}(this, (function (rcSelect,React,PropTypes,classnames) { 'use strict';
...
// just test
var SelectCell = (_dec$1 = hoc('sss'), _dec$1(_class$1 = function (_React$Component) {
...
var TableCell = function (_React$Component) {
	...
	TableCell.prototype.render = function render() {
		...
		var rowCellCls = (_rowCellCls = {}, _rowCellCls[ytTablePerfix$3 + '-row-cell'] = true, _rowCellCls[ytTablePerfix$3 + '-can-focus-cell'] = canFocusType.includes(column.type) || canFocus, _rowCellCls[ytTablePerfix$3 + '-active-cell'] = clicked, _rowCellCls);
